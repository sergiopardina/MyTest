...
@section('content')
    <h2>New lot</h2>
    <form action="{{ route('lot.store') }}" method="POST" class="form-horizontal">
        {{ csrf_field() }}

        <div class="form-group">
            <label for="lot-name" class="col-sm-3 control-label">Lot name</label>
            <div class="col-sm-6">
                <input type="text" name="name" id="lot-name" class="form-control">
            </div>

            <label for="lot-description" class="col-sm-3 control-label">Lot description</label>
            <div class="col-sm-6">
                <input type="text" name="description" id="lot-description" class="form-control">
            </div>
            <div class="col-sm-6">
